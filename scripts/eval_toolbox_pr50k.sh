...
python eval_toolbox/calc_metrics.py \
    ...
    --data ~/datasets/celeba_256_jpg \
    --mirror 1 \
    --gen_data generated_samples/latent_celeb256/explarge_dhariwal_unet_cauchy_no_grad_norm_diff_0.75_newdiff_fix_5_bs128_othard_cauchynew_newc_resumefrom81nfe_ep000${epoch} \
    --img_resolution 256
