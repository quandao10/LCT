...
do
    ...
    do
        CUDA_VISIBLE_DEVICES=0 torchrun --nnodes=1 --rdzv_endpoint 0.0.0.0:$MASTER_PORT --nproc_per_node=1 test_cm_latent_ddp.py \
                --ckpt ./results/latent_celeb256/large_dhariwal_unet_cauchy_no_grad_norm_bs128_othard_newc_allnonscalinglayernorm_newprecond/checkpoints/content.pth \
                --seed 42 \
            ...
            #     --mirror 1 \
            #     --gen_data generated_samples/latent_celeb256/explarge_dhariwal_unet_cauchy_no_grad_norm_bs128_othard_newc_allnonscalinglayernorm_newprecond_ep000${epoch}_${ema} \
            #     --img_resolution 256
    done
done
