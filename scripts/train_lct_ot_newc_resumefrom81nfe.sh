...
CUDA_VISIBLE_DEVICES=0 torchrun --nnodes=1 --rdzv_endpoint 0.0.0.0:$MASTER_PORT --nproc_per_node=1 train_cm_latent.py \
        --exp large_dhariwal_unet_cauchy_no_grad_norm_diff_0.75_newdiff_fix_5_bs128_othard_cauchynew_newc_resumefrom81nfe \
        --datadir ./dataset/ \
        ...
        --use-diffloss \
        --ot-hard \
        --custom-constant-c 0.00276883 \
        --model-ckpt results/latent_celeb256/large_dhariwal_unet_cauchy_no_grad_norm_diff_0.75_newdiff_fix_5_bs128_othard_cauchynew_newc_resumefrom81nfe/checkpoints/0000775.pt \
        # --resume \
