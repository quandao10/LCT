...
do
        CUDA_VISIBLE_DEVICES=0 torchrun --nnodes=1 --rdzv_endpoint 0.0.0.0:$MASTER_PORT --nproc_per_node=1 test_cm_latent_ddp.py \
                --ckpt results/latent_celeb256/dhariwal_unet_ict_large_batchsize_lr_decay_1k6_epoch_normalize_0.5_1280_nogradnorm_cauchy_positional_othard/checkpoints/000${epoch}.pt \
                --seed 42 \
...
do
    python pytorch_fid/fid_score.py \
        ...
        --device cuda:0 \
        --dims 2048 \
        generated_samples/latent_celeb256/expdhariwal_unet_ict_large_batchsize_lr_decay_1k6_epoch_normalize_0.5_1280_nogradnorm_cauchy_positional_othard_ep000${epoch} \
