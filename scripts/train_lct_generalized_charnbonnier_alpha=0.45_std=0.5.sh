...
CUDA_VISIBLE_DEVICES=1 torchrun --nnodes=1 --rdzv_endpoint 0.0.0.0:$MASTER_PORT --nproc_per_node=1 train_cm_latent.py \
        --exp dhariwal_unet_ict_large_batchsize_lr_decay_4k_epoch_normalize_generalized-charbonnier-alpha=0.45_std=0.5 \
        --datadir ./dataset/ \
        ...
        --num-classes 0 \
        --weight-schedule ict \
        --loss-norm generalized-charbonnier-alpha=0.45 \
