...
#         --exp imagenet_rebutt_edm_attn_48_silu_rho_11_soap \
#         --datadir /research/cbim/vast/qd66/workspace/dataset/ \
...
#         --rho 11. \
        # --resume
        # --ot-hard \
        # --model-ckpt /research/cbim/medical/qd66/lct_v2/compress_latent_imagenet512/imagenet_rebutt/checkpoints/0000245.pt \
