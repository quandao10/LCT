...
from models.sana.basic_modules import DWMlp, GLUMBConv, MBConvPreGLU, Mlp
from models.sana.sana import Sana, get_2d_sincos_pos_embed
from models.sana.sana_blocks import (
    Attention,
    CaptionEmbedder,
    LabelEmbedder,
    FlashAttention,
...
from models.sana.utils import auto_grad_checkpoint, is_triton_module_available, is_xformers_available

_triton_modules_available = False
if is_triton_module_available():
    from models.sana.fastlinear.modules import TritonLiteMLA, TritonMBConvPreGLU
...
class SanaMSBlock(nn.Module):
    ...
    def forward(self, x, t, mask=None, HW=None, **kwargs):
        B, N, C = x.shape
...
class SanaMS(Sana):
    ...
    def forward(self, x, timestep, y, mask=None, data_info=None, **kwargs):
        ...
        for block in self.blocks:
            ...
            x = auto_grad_checkpoint(
                block, x, t0, (self.h, self.w), **kwargs
            )  # (N, T, D) #support grad checkpoint
...
def SanaMS_B_2(**kwargs):
    return SanaMS(depth=12, hidden_size=768, patch_size=2, num_heads=12, **kwargs)


SanaMS_models = {
    'SanaMS_600M_P1_D28': SanaMS_600M_P1_D28,
    'SanaMS_600M_P2_D28': SanaMS_600M_P2_D28,
    'SanaMS_600M_P4_D28': SanaMS_600M_P4_D28,
    'SanaMS_1600M_P1_D20': SanaMS_1600M_P1_D20,
    'SanaMS_1600M_P2_D20': SanaMS_1600M_P2_D20,
    'SanaMS_B_2': SanaMS_B_2,
}