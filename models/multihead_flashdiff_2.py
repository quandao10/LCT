...
class MultiheadFlashDiff2(nn.Module):
    ...
    def __init__(
        ...
        num_heads,
        norm_layer,
        model_parallel_size=1, # model_parallel_size: number of GPUs used to parallelize model.
        ...
        self.subln = norm_layer(2 * self.head_dim, eps=1e-5, elementwise_affine=True) # RMSNorm(2 * self.head_dim, eps=1e-5, elementwise_affine=True)
