...
from models.lightningdit.swiglu_ffn import SwiGLUFFN 
from models.lightningdit.pos_embed import VisionRotaryEmbeddingFast
from models.lightningdit.rmsnorm import RMSNorm
...
class LightningDiT(nn.Module):
    ...
    def forward(self, x, t=None, y=None, is_train=False):
        """
