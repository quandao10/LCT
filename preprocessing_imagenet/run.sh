...
# python preprocessing_imagenet/dataset_tools.py convert --source=/lustre/scratch/client/vinai/users/anhnd72/datasets/real_imagenet/train \
...
python preprocessing_imagenet/dataset_tools.py encode --source=/lustre/scratch/client/movian/research/users/anhnd72/datasets/LCT/real_imagenet_256/images \
