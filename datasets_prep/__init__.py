...
from datasets_prep.dataset_edm2 import ExtractedDataset
...
class RepaDataset(Dataset):
    def __init__(self, base_dir):
        ...
        self.basename_files = [os.path.basename(file).split(".")[0] for file in all_files][:64]
...
def get_dataset(args):
    ...
    if args.dataset == "cifar10":
        ...
        dataset = ExtractedDataset(f"{args.datadir}/latent_imagenet_512", use_labels=True)
    # elif args.dataset == "latent_ffhq256":
